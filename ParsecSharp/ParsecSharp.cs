...
namespace ParsecSharp
{
	...
	internal struct OpaqueContainer
	{
		public IntPtr caller;
		public IntPtr opaque;
			
		public OpaqueContainer(IntPtr caller, IntPtr opaque)
		{
			this.caller = caller;
			this.opaque = opaque;
		}
	...
	internal unsafe delegate void LogCallbackInternal(LogLevel level, sbyte* msg, IntPtr opaque);
	...
	public delegate void FrameCallback(Frame frame, IntPtr image, IntPtr opaque);

	[SuppressUnmanagedCodeSecurity]
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate void FrameCallbackInternal(IntPtr frame, byte* image, OpaqueContainer* container);
	...
	public delegate void AudioCallback(IntPtr pcm, uint frames, IntPtr opaque);
	
	[SuppressUnmanagedCodeSecurity]
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate void AudioCallbackInternal(short* pcm, uint frames, OpaqueContainer* opaque);
	...
	public unsafe struct ParsecConfig
	{
		...
		internal static ParsecConfig CreateInstance(IntPtr native)
		{
			return new ParsecConfig(native.ToPointer());
		}

		internal static ParsecConfig CreateInstance(Internal native)
		{
			return new ParsecConfig(native);
		}

		private ParsecConfig(Internal native)
			: this()
		{
			instance = native;
		}

		private ParsecConfig(void* native) : this()
		{
	...
	public sealed unsafe class Parsec : IDisposable
	{
		...
		private readonly static Dictionary<IntPtr, Parsec> Instances = 
			new Dictionary<IntPtr, Parsec>();
		...
		private static Parsec GetInstance(IntPtr caller)
		{
			lock (Instances)
			{
				return Instances[caller];
			}
		}
		...
		public Status ClientGetStatus(out ClientStatus status)
		{
			var arg0 = new IntPtr();
			var ret = Internal.ClientGetStatus(Instance, new IntPtr(&arg0));
			status = ClientStatus.CreateInstance(arg0);
			return ret;
		}
		...
		public Status ClientPollFrame(uint timeout, IntPtr opaque)
		{
			var container = new OpaqueContainer(Instance, opaque);
			return Internal.ClientPollFrame(
				Instance, FrameCallbackInternalPtr, timeout, new IntPtr(&container));
		}
		
		private static IntPtr FrameCallbackInternalPtr { get; } =
			Marshal.GetFunctionPointerForDelegate(new FrameCallbackInternal(FrameCallbackInternal));

		private static void FrameCallbackInternal(IntPtr pFrame, byte* image, OpaqueContainer *container)
		{
			GetInstance(container->caller).ClientPollFrameCallback?.Invoke(
				Frame.CreateInstance(pFrame), new IntPtr(image), container->opaque);
		}

		public event FrameCallback ClientPollFrameCallback;

		public Status ClientPollAudio(AudioCallback callback, uint timeout, IntPtr opaque)
		{
			var container = new OpaqueContainer(Instance, opaque);
			var ret = Internal.ClientPollAudio(
				Instance, AudioCallbackInternalPtr, timeout, new IntPtr(&container));
			return ret;
		}
		
		private static IntPtr AudioCallbackInternalPtr { get; } =
			Marshal.GetFunctionPointerForDelegate(new AudioCallbackInternal(AudioCallbackInternal));

		private static void AudioCallbackInternal(short* pcm, uint frames, OpaqueContainer *container)
		{
			GetInstance(container->caller).ClientPollAudioCallback?.Invoke(
				new IntPtr(pcm), frames, container->opaque);
		}

		public event AudioCallback ClientPollAudioCallback;
		...
		{
			var instance = msg.CreateInternal();
		...
		public void HostGetStatus(out HostStatus status)
		{
			var arg0 = new IntPtr();
			Internal.HostGetStatus(Instance, new IntPtr(&arg0));
			if (arg0 == IntPtr.Zero)
			{
				throw new NullReferenceException();
			}
			status = HostStatus.CreateInstance(arg0);
		}
		...
		public bool HostPollInput(uint timeout, Guest guest, out Message msg)
		{
			var instance = guest.Instance;
			var arg1 = new IntPtr(&instance);
			var arg2 = new IntPtr();
			var ret = Internal.HostPollInput(Instance, timeout, arg1, new IntPtr(&arg2));
			msg = Message.CreateInstance(arg2);
			return ret;
		}
		...
		private static void LogCallbackInternal(LogLevel level, sbyte* msg, IntPtr opaque)
		{
			logCallback?.Invoke(level, MarshalUtil.GetString(msg, 0));
		}
		...
		public static event LogCallback LogCallback
		{
			add
			{
				if (logCallback == null)
				{
					Internal.SetLogCallback(Marshal.GetFunctionPointerForDelegate(
						new LogCallbackInternal(LogCallbackInternal)), IntPtr.Zero);
				}
				logCallback += value;
			}
			remove
			{
				...
				if (logCallback == null)
				{
					Internal.SetLogCallback(IntPtr.Zero, IntPtr.Zero);
				}
			}
		}
	...
	public unsafe struct Frame
	{
		...
		internal static Frame CreateInstance(IntPtr native)
		{
			return new Frame(native.ToPointer());
		}

		internal static Frame CreateInstance(Internal native)
		{
			return new Frame(native);
		}

		private Frame(Internal native)
			: this()
		{
			instance = native;
		}

		private Frame(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public unsafe struct Cursor
	{
		...
		internal static Cursor CreateInstance(IntPtr native)
		{
			return new Cursor(native.ToPointer());
		}

		internal static Cursor CreateInstance(Internal native)
		{
			return new Cursor(native);
		}

		private Cursor(Internal native)
			: this()
		{
			instance = native;
		}

		private Cursor(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public unsafe struct Permissions
	{
		...
		internal static Permissions CreateInstance(IntPtr native)
		{
			return new Permissions(native.ToPointer());
		}

		internal static Permissions CreateInstance(Internal native)
		{
			return new Permissions(native);
		}

		private Permissions(Internal native)
			: this()
		{
			instance = native;
		}

		private Permissions(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public unsafe struct Metrics
	{
		...
		internal static Metrics CreateInstance(IntPtr native)
		{
			return new Metrics(native.ToPointer());
		}

		internal static Metrics CreateInstance(Internal native)
		{
			return new Metrics(native);
		}

		private Metrics(Internal native)
			: this()
		{
			instance = native;
		}

		private Metrics(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public unsafe struct Guest
	{
		...
		internal static Guest CreateInstance(IntPtr native)
		{
			return new Guest(native.ToPointer());
		}

		internal static Guest CreateInstance(Internal native)
		{
			return new Guest(native);
		}

		private Guest(Internal native)
			: this()
		{
			instance = native;
		}

		private Guest(void* native) : this()
		{
			instance = *(Internal*)native;
		}
		...
		{
			get => Permissions.CreateInstance(instance.perms);
			set => instance.perms = value.Instance;
		}

		/// <summary>Latency performance metrics, only valid in state ::GUEST_CONNECTED.</summary>
		public Metrics Metrics
		{
			get => Metrics.CreateInstance(instance.metrics);
			set => instance.metrics = value.Instance;
		}
	...
	{
		[StructLayout(LayoutKind.Sequential, Size = 12)]
		internal unsafe new struct Internal
		{
		...
		internal KeyboardMessage(Internal native)
		{
			instance = native;
		}

		protected override void FillInternal(ref Message.Internal internalEvent)
		{
			internalEvent.keyboard = instance;
		}
	...
	public class MouseButtonMessage : Message
	{
		...
		internal MouseButtonMessage(Internal native)
		{
			instance = native;
		}
		...
		protected override void FillInternal(ref Message.Internal internalEvent)
		{
			internalEvent.mouseButton = instance;
		}
	...
	public class MouseWheelMessage : Message
	{
		...
		internal MouseWheelMessage(Internal native)
		{
			instance = native;
		}
		...
		protected override void FillInternal(ref Message.Internal internalEvent)
		{
			internalEvent.mouseWheel = instance;
		}
	...
	///     </para>
	/// </remarks>
	public class MouseMotionMessage : Message
	{
		[StructLayout(LayoutKind.Sequential, Size = 12)]
		internal unsafe new struct Internal
		{
		...
		public override MessageType Type => MessageType.MouseMotion;

		internal MouseMotionMessage(Internal native)
		{
			instance = native;
		}
		...
		protected override void FillInternal(ref Message.Internal internalEvent)
		{
			internalEvent.mouseMotion = instance;
		}
	...
	/// <summary>Gamepad button message.</summary>
	/// <remarks>Member of ::ParsecMessage.</remarks>
	public class GamepadButtonMessage : Message
	{
		[StructLayout(LayoutKind.Sequential, Size = 12)]
		internal unsafe new struct Internal
		{
		...
		public override MessageType Type => MessageType.GamepadButton;

		internal GamepadButtonMessage(Internal native)
		{
			instance = native;
		}
		...
		protected override void FillInternal(ref Message.Internal internalEvent)
		{
			internalEvent.gamepadButton = instance;
		}
	...
	/// <summary>Gamepad axis message.</summary>
	/// <remarks>Member of ::ParsecMessage.</remarks>
	public class GamepadAxisMessage : Message
	{
		[StructLayout(LayoutKind.Sequential, Size = 12)]
		internal unsafe new struct Internal
		{
		...
		public override MessageType Type => MessageType.GamepadAxis;

		internal GamepadAxisMessage(Internal native)
		{
			instance = native;
		}
		...
		protected override void FillInternal(ref Message.Internal internalEvent)
		{
			internalEvent.gamepadAxis = instance;
		}
	...
	/// <summary>Gamepad unplug message.</summary>
	/// <remarks>Member of ::ParsecMessage.</remarks>
	public class GamepadUnplugMessage : Message
	{
		[StructLayout(LayoutKind.Sequential, Size = 4)]
		internal new struct Internal
		{
		...
		public override MessageType Type => MessageType.GamepadUnplug;

		internal GamepadUnplugMessage(Internal native)
		{
			instance = native;
		}
		...
		protected override void FillInternal(ref Message.Internal internalEvent)
		{
			internalEvent.gamepadUnplug = instance;
		}
	...
	public abstract class Message
	{
		...
		protected internal struct Internal
		{
		...
		internal unsafe static Message CreateInstance(IntPtr native)
		{
			var internalEvent = *(Internal*)native.ToPointer();
			switch (internalEvent.type)
			{
				case MessageType.Keyboard:
					return new KeyboardMessage(internalEvent.keyboard);
				case MessageType.MouseButton:
					return new MouseButtonMessage(internalEvent.mouseButton);
				case MessageType.MouseWheel:
					return new MouseWheelMessage(internalEvent.mouseWheel);
				case MessageType.MouseMotion:
					return new MouseMotionMessage(internalEvent.mouseMotion);
				case MessageType.GamepadButton:
					return new GamepadButtonMessage(internalEvent.gamepadButton);
				case MessageType.GamepadAxis:
					return new GamepadAxisMessage(internalEvent.gamepadAxis);
				case MessageType.GamepadUnplug:
					return new GamepadUnplugMessage(internalEvent.gamepadUnplug);
				default:
					throw new ArgumentOutOfRangeException(nameof(internalEvent.type));
			}
		}
		
		protected abstract void FillInternal(ref Internal internalEvent);

		internal Internal CreateInternal()
		{
			var instance = new Internal
			{
				type = Type
			};
			FillInternal(ref instance);
			return instance;
		}
	}
	...
	public unsafe struct ClientConfig
	{
		...
		internal static ClientConfig CreateInstance(IntPtr native)
		{
			return new ClientConfig(native.ToPointer());
		}

		internal static ClientConfig CreateInstance(Internal native)
		{
			return new ClientConfig(native);
		}

		private ClientConfig(Internal native)
			: this()
		{
			instance = native;
		}

		private ClientConfig(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public unsafe struct ClientStatus
	{
		...
		internal static ClientStatus CreateInstance(IntPtr native)
		{
			return new ClientStatus(native.ToPointer());
		}

		internal static ClientStatus CreateInstance(Internal native)
		{
			return new ClientStatus(native);
		}

		private ClientStatus(Internal native)
			: this()
		{
			instance = native;
		}

		private ClientStatus(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public class ClientCursorEvent : ClientEvent
	{
		...
		internal ClientCursorEvent(Internal native)
		{
			instance = native;
		}
		...
		{
			get => Cursor.CreateInstance(instance.cursor);
			set => instance.cursor = value.Instance;
		}
	...
	/// <summary>Gamepad rumble data event.</summary>
	/// <remarks>Member of ::ParsecClientEvent.</remarks>
	public unsafe class ClientRumbleEvent : ClientEvent
	{
		[StructLayout(LayoutKind.Sequential, Size = 8)]
		internal new struct Internal
		{
		...
		internal ClientRumbleEvent(Internal native)
		{
			instance = native;
		}
	...
	public class ClientUserDataEvent : ClientEvent
	{
		...
		internal ClientUserDataEvent(Internal native)
		{
			instance = native;
		}
	...
	public abstract class ClientEvent
	{
		...
		private struct Internal
		{
			...
			[FieldOffset(4)] internal ClientCursorEvent.Internal cursor;

			[FieldOffset(4)] internal ClientRumbleEvent.Internal rumble;

			[FieldOffset(4)] internal ClientUserDataEvent.Internal userData;
		}
		...
		internal unsafe static ClientEvent CreateInstance(IntPtr native)
		{
			...
			switch (internalEvent.type)
			{
				case ClientEventType.Cursor:
					return new ClientCursorEvent(internalEvent.cursor);
				case ClientEventType.Rumble:
					return new ClientRumbleEvent(internalEvent.rumble);
				case ClientEventType.UserData:
					return new ClientUserDataEvent(internalEvent.userData);
	...
	public unsafe struct HostConfig
	{
		...
		internal static HostConfig CreateInstance(IntPtr native)
		{
			return new HostConfig(native.ToPointer());
		}

		internal static HostConfig CreateInstance(Internal native)
		{
			return new HostConfig(native);
		}

		private HostConfig(Internal native)
			: this()
		{
			instance = native;
		}

		private HostConfig(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public unsafe struct HostStatus
	{
		...
		internal static HostStatus CreateInstance(IntPtr native)
		{
			return new HostStatus(native.ToPointer());
		}

		internal static HostStatus CreateInstance(Internal native)
		{
			return new HostStatus(native);
		}

		private HostStatus(Internal native)
			: this()
		{
			instance = native;
		}

		private HostStatus(void* native) : this()
		{
			instance = *(Internal*)native;
		}
	...
	public class GuestStateChangeEvent : HostEvent
	{
		...
		internal GuestStateChangeEvent(Internal native)
		{
			instance = native;
		}
		...
		public Guest Guest
		{
			get => Guest.CreateInstance(instance.guest);
			set => instance.guest = value.Instance;
		}
	}
	...
	public class UserDataEvent : HostEvent
	{
		...
		internal UserDataEvent(Internal native)
		{
			instance = native;
		}
	...
	public abstract class HostEvent
	{
		...
		private struct Internal
		{
			...
			[FieldOffset(4)] internal GuestStateChangeEvent.Internal guestStateChange;

			[FieldOffset(4)] internal UserDataEvent.Internal userData;
		}
		
		public abstract HostEventType Type { get; }

		internal unsafe static HostEvent CreateInstance(IntPtr native)
		{
			var internalEvent = *(Internal*)native.ToPointer();
			switch (internalEvent.type)
			{
				case HostEventType.GuestStateChange:
					return new GuestStateChangeEvent(internalEvent.guestStateChange);
				case HostEventType.UserData:
					return new UserDataEvent(internalEvent.userData);
